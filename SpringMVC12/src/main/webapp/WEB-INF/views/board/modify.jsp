	    	...
	    	<form id="frm" method="post">
		    	<table class="table table-bordered">
			    	<tr>
		    			<td>번호</td>
		    			<td>
		    				<input type="text" class="form-control" id="idx" name="idx" readonly="readonly" value="${vo.idx}" />
		    			</td>
		 				</tr>    			
			    	<tr>
		    			<td>제목</td>
			    	...
			    	<tr>
		    			<td>내용</td>
		    			<td>
		    				<textarea rows="10" class="form-control" id="content" name="content"><c:out value='${vo.content}'/></textarea>
		    			</td>
		 				</tr>
			    	<tr>
		    			<td>작성자</td>
